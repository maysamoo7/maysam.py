...
for agent in range(10000):
 ...
 Facebook  : Ma2YSAM JAN
 Tool Name : MRX
 Type type : FREE
 Version   : 1.0.5
 WhatsApp  : +93791987833
 q
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system('clear')
        os.system('xdg-open https://www.facebook.com/profile.php?id=100078468564693)
        print(logo)
loop=0
oks=[]
cps=[]
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+93791987833&text="
